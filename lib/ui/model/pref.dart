...
class Pref{
  ...
  init() async {
    print("DATA SET HERE ----------------------------->>> CALL 11 " + (_prefs == null).toString());
    await _init2();
  }

  _init2() async {
    print("DATA SET HERE ----------------------------->>> SET GET " + (_prefs == null).toString());
    _prefs = await SharedPreferences.getInstance();
  }

  set(String key, String value)  async {
    print("DATA SET HERE ----------------------------->>> SET Prefs " + (_prefs == null).toString());
    if (_prefs == null)
      await _init2();
    _prefs.setString(key, value);
    print("DATA SET HERE ----------------------------->>> SET " + key + " VA VAL " + value);
  }
