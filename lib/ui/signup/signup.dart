    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Text(strings.get(301),                        // "Create an Account!"
        ...
        Container(
            ...
            child:
            IInputField2a(
              hint: strings.get(302),            // "E-mail address",
  ...
  void onLoginStatusChanged(bool isLoggedIn, {profileData}) {
    setState(() {
      ...
      if (isLoggedIn) {
        ...
        _login("facebook", profileData['id'], profileData['name'], profileData['picture']['data']['url'], profileData['email']);
      }
    });
  }
}