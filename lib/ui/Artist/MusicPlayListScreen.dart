...
// }
//
// class _PlayScreenState extends State<MusicPlayListScreen> {
...
//       try {
//         file = await File(
//             '${tempDir.path}/${playTitle.toString().replaceAll(
//                 '/', '')}-${playArtist.toString().replaceAll('/', '')}.jpg')
//             .create();
