...
loadSecondStep(String uid, String ArtistID, Function(SecondStepData) callback,
    Function(String) callbackError) async {
  try {
    var url = "${serverPath}getSecondStep";
    //var url = "${serverPath}getSecondStepNew";

    var body = json.encoder.convert({'artist_id': '$ArtistID'});
    print(
        "Artist ID PAss here URL -->> > " + url + " BODY >" + body.toString());
