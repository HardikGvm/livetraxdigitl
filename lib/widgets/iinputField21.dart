...
class IInputField21 extends StatefulWidget {
  final String hint;
  final IconData icon;
  ...
  IInputField21({this.hint, this.icon, this.controller, this.type, this.colorDefaultText, this.colorBackground,
    this.iconRight, this.onPressRightIcon, this.onChangeText, this.maxLenght});

  @override
  _IInputField21State createState() => _IInputField21State();
}

class _IInputField21State extends State<IInputField21> {
